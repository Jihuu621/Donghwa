Create one clean full-body reference sprite for Codex pet dubu.

Pet identity: Preserve Dubu exactly from the existing spritesheet: a stylized human underground MC; retain face, attire, palette, silhouette, and any props. Upgrade only by adding natural, readable look directions..
